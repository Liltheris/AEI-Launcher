...
websiteBtn.addEventListener('click', event => shell.openExternal("https://empireinherited.fandom.com/"));
discordBtn.addEventListener('click', event => shell.openExternal("https://discord.gg/7cqzCBMebB"));
